...
export default function AboutContent() {
  return (
    <>
      ...
      {/* Origin Story */}
      <section className="px-8 py-36 lg:px-16 lg:py-52" aria-label="Our story">
      ...
      {/* Founding Team */}
      <section className="px-8 py-36 lg:px-16 lg:py-52" aria-label="Our team">
        <div className="mx-auto max-w-[1400px]">
          <div className="mb-24">
            <AnimatedText>
          ...
          <div className="grid gap-20 sm:grid-cols-2 lg:grid-cols-3 lg:gap-16">
            {team.map((member, i) => (
              <AnimatedText key={member.name} delay={0.15 + i * 0.12}>
                <div className="group">
                  ...
                  <div className="mt-8">
                    <h3 className="font-serif text-xl tracking-[0.08em] text-charcoal">
                      {member.name}
                    </h3>
                    <p className="mt-2 font-body text-[0.65rem] font-light tracking-[0.15em] uppercase text-gold/60">
                      {member.role}
                    </p>
                    <p className="mt-6 text-sm leading-[1.8] text-charcoal/50">
                      {member.bio}
                    </p>
                  </div>
                </div>
      ...
      {/* Values */}
      <section className="px-8 py-36 lg:px-16 lg:py-52" aria-label="Our values">
        <div className="mx-auto max-w-[1200px]">
          <div className="mb-24">
            <AnimatedText>
              <p className="font-body text-[0.65rem] font-light tracking-[0.25em] uppercase text-sage">
          ...
          <div className="space-y-24 lg:space-y-28">
            {values.map((value, i) => (
              <AnimatedText key={value.number} delay={0.1}>
                <div className="grid gap-8 lg:grid-cols-[100px_220px_1fr] lg:gap-16 lg:items-start">
                  <span className="font-serif text-5xl font-light text-gold/30 lg:text-6xl">
                    {value.number}
                  </span>
                  <h3 className="font-serif text-2xl tracking-[0.06em] text-charcoal lg:pt-2">
                    {value.title}
                  </h3>
                  <p className="text-[0.95rem] leading-[2] text-charcoal/55 lg:pt-2">
                    {value.description}
                  </p>
                </div>
              </AnimatedText>
