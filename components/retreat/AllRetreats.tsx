      ...
      >
        <div className="relative aspect-[4/5] overflow-hidden">
          ...
          <div className="absolute bottom-0 left-0 right-0 p-8">
            ...
            <h3 className="mt-2 font-serif text-3xl tracking-[0.12em] text-linen">
              {destination}
            </h3>
          </div>
        </div>
...
export default function AllRetreats() {
  return (
    <>
      ...
      {/* Introduction */}
      <section className="px-8 py-36 lg:px-16 lg:py-44">
        <div className="mx-auto max-w-3xl">
          <AnimatedText>
            <p className="font-serif text-2xl italic font-light leading-relaxed text-charcoal/70 sm:text-3xl sm:leading-relaxed text-center">
      ...
      {/* Retreats grid */}
      <section className="px-8 pb-36 lg:px-16 lg:pb-52" aria-label="All retreats">
        <div className="mx-auto max-w-[1400px]">
