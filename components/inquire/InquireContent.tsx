...
export default function InquireContent() {
  ...
  return (
    <>
      ...
      {/* Form section */}
      <section className="px-6 py-24 md:px-10 md:py-32 lg:px-16 lg:py-40 xl:px-20 xl:py-48" aria-label="Inquiry form">
        <div className="mx-auto max-w-[1400px]">
          <div className="grid gap-14 md:gap-16 lg:grid-cols-[1fr_1.1fr] lg:gap-24 xl:gap-32 lg:items-start">
            {/* Left: copy */}
            <div>
              <AnimatedText>
                <h2 className="font-serif text-[1.75rem] md:text-3xl lg:text-4xl xl:text-[2.6rem] tracking-[0.06em] text-charcoal leading-[1.25]">
              ...
              <AnimatedText delay={0.35}>
                <p className="mt-4 md:mt-6 text-[0.9rem] md:text-[0.95rem] leading-[1.85] text-charcoal/50">
              ...
              <AnimatedText delay={0.5}>
                <div className="mt-10 md:mt-14 lg:mt-16 space-y-5 md:space-y-6 border-l border-sage/25 pl-6 md:pl-8">
                  <div>
                    <p className="font-body text-[0.6rem] font-light tracking-[0.2em] uppercase text-charcoal/30">
                      Response Time
                    </p>
                    <p className="mt-1.5 font-serif text-sm md:text-base text-charcoal">Within 48 hours</p>
                  </div>
                  <div>
                    <p className="font-body text-[0.6rem] font-light tracking-[0.2em] uppercase text-charcoal/30">
                      Discretion
                    </p>
                    <p className="mt-1.5 font-serif text-sm md:text-base text-charcoal">
            ...
            <AnimatedText delay={0.2}>
              {status === "success" ? (
                <motion.div
                  ...
                  className="flex flex-col items-center justify-center py-14 md:py-20 text-center"
                >
                  <p className="font-serif text-2xl md:text-3xl italic font-light text-charcoal/80">
                    Thank you.
                  </p>
                  <p className="mt-4 md:mt-6 text-sm leading-relaxed text-charcoal/50 max-w-sm">
                ...
                <form onSubmit={handleSubmit} className="space-y-8 md:space-y-10">
                  <div>
                    <label
                      ...
                      className="block font-body text-[0.6rem] font-light tracking-[0.2em] uppercase text-charcoal/40 mb-2 md:mb-3"
                    >
                      Name
                    </label>
                    <input
                      ...
                      className="w-full border-b border-charcoal/15 bg-transparent py-3 md:py-4 font-body text-[0.9rem] md:text-[0.95rem] font-light text-charcoal placeholder:text-charcoal/25 focus:border-sage focus:outline-none transition-colors duration-300"
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      rows={4}
                      className="w-full resize-none border-b border-charcoal/15 bg-transparent py-3 md:py-4 font-body text-[0.9rem] md:text-[0.95rem] font-light text-charcoal placeholder:text-charcoal/25 focus:border-sage focus:outline-none transition-colors duration-300"
