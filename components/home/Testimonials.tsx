...
export default function Testimonials() {
  ...
  return (
    <section
      className="bg-charcoal px-8 py-36 lg:px-16 lg:py-52"
      aria-label="Guest reflections"
    >
      <div className="mx-auto max-w-4xl text-center">
        <p className="mb-20 font-body text-[0.65rem] font-light tracking-[0.3em] uppercase text-linen/25">
          Guest Reflections
        </p>
        ...
        <div className="relative min-h-[240px] sm:min-h-[200px]">
          <AnimatePresence mode="wait">
            ...
            >
              <blockquote className="font-serif text-2xl italic font-light leading-relaxed text-linen/75 sm:text-3xl sm:leading-relaxed lg:text-[2rem] lg:leading-[1.7]">
